...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            'accueil.attribution' => 'getAccueil_AttributionService',
    ...
    /**
     * Gets the 'accueil.attribution' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \AccueilBundle\AttributionTarifs\AccueilAttributionTarifs A AccueilBundle\AttributionTarifs\AccueilAttributionTarifs instance.
     */
    protected function getAccueil_AttributionService()
    {
        return $this->services['accueil.attribution'] = new \AccueilBundle\AttributionTarifs\AccueilAttributionTarifs($this->get('doctrine.orm.default_entity_manager'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => 8889, 'dbname' => 'museedulouvre', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array(), 'serverVersion' => 5.5, 'defaultTableOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/AccueilBundle/Entity'), 1 => ($this->targetDirs[3].'/vendor/webonaute/doctrine-fixtures-generator-bundle/Webonaute/DoctrineFixturesGeneratorBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'AccueilBundle\\Entity');
        $c->addDriver($b, 'Webonaute\\DoctrineFixturesGeneratorBundle\\Entity');

        $d = new \Doctrine\ORM\Configuration();
        $d->setEntityNamespaces(array('AccueilBundle' => 'AccueilBundle\\Entity', 'DoctrineFixturesGeneratorBundle' => 'Webonaute\\DoctrineFixturesGeneratorBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_c08e7c923e36d4d83bfc6c92ea853c2a53942d1e2c31a2f1fcef94cfa5c4d72a');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('virtual.triathlon.manager@gmail.com');
        $a->setPassword('m3bs45cc');
        $a->setAuthMode('login');
    ...
    {
        return $this->services['swiftmailer.plugin.redirecting'] = new \Swift_Plugins_RedirectingPlugin(array(0 => 'virtual.triathlon.manager@gmail.com'), array());
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ThisTokenIsNotSoSecretButIsSpecialToComposerAsAService');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5735a57ed187e7.65528936')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DoctrineFixturesGeneratorBundle' => 'Webonaute\\DoctrineFixturesGeneratorBundle\\DoctrineFixturesGeneratorBundle',
            ),
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'appDevDebugProjectContainer',
            'database_host' => '127.0.0.1',
            'database_port' => 8889,
            'database_name' => 'museedulouvre',
            'database_user' => 'root',
            ...
            'secret' => 'ThisTokenIsNotSoSecretButIsSpecialToComposerAsAService',
            'locale' => 'fr',
            ...
            'kernel.secret' => 'ThisTokenIsNotSoSecretButIsSpecialToComposerAsAService',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'virtual.triathlon.manager@gmail.com',
            'swiftmailer.mailer.default.transport.smtp.password' => 'm3bs45cc',
            ...
            'swiftmailer.mailer.default.single_address' => 'virtual.triathlon.manager@gmail.com',
            'swiftmailer.mailer.default.delivery_addresses' => array(
                0 => 'virtual.triathlon.manager@gmail.com',
            ),
            ...
            'swiftmailer.single_address' => 'virtual.triathlon.manager@gmail.com',
