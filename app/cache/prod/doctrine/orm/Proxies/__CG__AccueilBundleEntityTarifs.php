 ...
 */
class Tarifs extends \AccueilBundle\Entity\Tarifs implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'AccueilBundle\\Entity\\Tarifs' . "\0" . 'id', '' . "\0" . 'AccueilBundle\\Entity\\Tarifs' . "\0" . 'nom', '' . "\0" . 'AccueilBundle\\Entity\\Tarifs' . "\0" . 'info', '' . "\0" . 'AccueilBundle\\Entity\\Tarifs' . "\0" . 'prix', '' . "\0" . 'AccueilBundle\\Entity\\Tarifs' . "\0" . 'slug');
        }
